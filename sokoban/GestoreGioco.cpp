...
GestoreGioco::GestoreGioco()
{
	...
	posGiocatoreY = new int[numLivelli+1];
 	...
 	const int nCasse[numLivelli+1] = {2,  0,  0,  0,  0,  0,  0,  0,  0,  0};
	const int nMuri[numLivelli+1] = {23,  0,  0,  0,  0,  0,  0,  0,  0,  0};
	int PGx[numLivelli+1] =   {128,  0,  0,  0,  0,  0,  0,  0,  0,  0};
	int PGy[numLivelli+1] =  {192,  0,  0,  0,  0,  0,  0,  0,  0,  0};
