...
Livello::Livello(const Coordinate& g, vector<Cassa*> c, vector<Coordinate*> m, ALLEGRO_BITMAP* PG, ALLEGRO_BITMAP* B, ALLEGRO_BITMAP* C, ALLEGRO_DISPLAY* D, ALLEGRO_SAMPLE_INSTANCE* sI, bool mod)
{
	this->inizializzaAllegro(D, sI);
...
void Livello::inizializzaAllegro(ALLEGRO_DISPLAY* D, ALLEGRO_SAMPLE_INSTANCE* sI)
{
	if(!al_init())
